/*
  ...
  - Made the column `Eid` on table `Employee` required. This step will fail if there are existing NULL values in that column.
...
INSERT INTO "new_Employee" ("Eid", "baseId", "createdAt", "email", "fullName", "isBlocked", "isDeleted", "passwordHash", "phone", "positionId", "role", "updatedAt") SELECT "Eid", "baseId", "createdAt", "email", "fullName", "isBlocked", "isDeleted", "passwordHash", "phone", "positionId", "role", "updatedAt" FROM "Employee";
DROP TABLE "Employee";
...
CREATE TABLE "new_Team" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "Team_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "Employee" ("Eid") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "Team_leaderId_fkey" FOREIGN KEY ("leaderId") REFERENCES "Employee" ("Eid") ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE "new_TeamMember" (
    ...
    CONSTRAINT "TeamMember_employeeId_fkey" FOREIGN KEY ("employeeId") REFERENCES "Employee" ("Eid") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "new_WorkAssignment" (
    ...
    CONSTRAINT "WorkAssignment_employeeId_fkey" FOREIGN KEY ("employeeId") REFERENCES "Employee" ("Eid") ON DELETE RESTRICT ON UPDATE CASCADE
);
